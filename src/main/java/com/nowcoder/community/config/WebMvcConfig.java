...
import com.nowcoder.community.controller.DateInterceptor;
...
//                "/**/*.jpeg","/**/*.jpg");
//        registry.addInterceptor(messageIntercepter).excludePathPatterns("/**/*.css","/**/*.js","/**/*.png",
//                "/**/*.jpeg","/**/*.jpg");
        registry.addInterceptor(dateInterceptor).excludePathPatterns("/**/*.css","/**/*.js","/**/*.png",
                "/**/*.jpeg","/**/*.jpg");
    }
}
